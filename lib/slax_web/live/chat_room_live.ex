defmodule SlaxWeb.ChatRoomLive do
  ...
  def handle_event("join-room", _, socket) do
    ...
    Chat.list_joined_rooms(current_user)
  ...
  defp message(assigns) do
    ...
    <div id={@dom_id} class="group relative flex px-4 py-3">
      <button
        ...
        class="absolute top-4 right-4 text-red-500 hover:red-800 cursor-pointer opacity-0 group-hover:opacity-100 focus:opacity-100"
      ...
      <img class="h-10 w-10 rounded shrink-0 bg-slate-300" src={~p"/images/one_ring.jpg"} />
      <div class="ml-2">
        <div class="-mt-1">
